		...
		while ($a=mysql_fetch_array($r))
		{
			...
			if (!$samelevel)
			{
				...
				while(($f=readdir($wd))!=false)
				{
					...
					print("<tr><td><a href='dl.php?sf=".$rf.$f."'>$f</a></td><td></td><td>".date("F d, Y",filemtime($rq.$f))."</td></tr>");
				}
				print("</table>");
				...
				{
					if ($f=="." || $f==".." || $f=="ak") continue;
					print("<tr><td><a href='dl.php?sf=".$rf."ak/".$f."'>$f</a></td><td></td><td>".date("F d, Y",filemtime($rq.$f))."</td></tr>");
				}
				print("</table>");
